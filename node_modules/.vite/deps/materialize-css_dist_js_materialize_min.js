...
var require_materialize_min = __commonJS({
  "node_modules/materialize-css/dist/js/materialize.min.js"(exports, module) {
    ...
    window.cash = function() {
      ...
      function x(t2, e2) {
        var i2 = M2(t2);
        return i2[e2] === void 0 && (i2[e2] = t2.dataset ? t2.dataset[e2] : _(t2).attr("data-" + e2)), i2[e2];
      }
    ...
    !function(t) {
      ...
      return M;
    }) : typeof exports == "undefined" || exports.nodeType || (typeof module != "undefined" && !module.nodeType && module.exports && (exports = module.exports = M), exports.default = M), M.keys = { TAB: 9, ENTER: 13, ESC: 27, ARROW_UP: 38, ARROW_DOWN: 40 }, M.tabPressed = false, M.keyDown = false;
    ...
    M.anime = function() {
      ...
      function O(t) {
        ...
        function e(t2) {
          ...
          (n2 <= a2 || !e2) && (k2.began || (k2.began = true, p2("begin")), p2("run")), i2 < a2 && a2 < e2 ? c2(a2) : (a2 <= i2 && s2 !== 0 && (c2(0), o2 && v2()), (e2 <= a2 && s2 !== e2 || !e2) && (c2(e2), o2 || v2())), p2("update"), e2 <= t2 && (k2.remaining ? (m2 = f2, k2.direction === "alternate" && (k2.reversed = !k2.reversed)) : (k2.pause(), k2.completed || (k2.completed = true, p2("complete"), "Promise" in window && (_2(), y2 = d2()))), g2 = 0);
        }
        t = t === void 0 ? {} : t;
      ...
      var e = { alignment: "left", autoFocus: true, constrainWidth: true, container: null, coverTrigger: true, closeOnClick: true, hover: false, inDuration: 150, outDuration: 250, onOpenStart: null, onOpenEnd: null, onCloseStart: null, onCloseEnd: null, onItemClick: null }, t = function(t2) {
        function n(t3, e2) {
          ...
          return i.el.M_Dropdown = i, n._dropdowns.push(i), i.id = M.getIdFromTrigger(t3), i.dropdownEl = document.getElementById(i.id), i.$dropdownEl = h(i.dropdownEl), i.options = h.extend({}, n.defaults, e2), i.isOpen = false, i.isScrollable = false, i.isTouchMoving = false, i.focusedIndex = -1, i.filterQuery = [], i.options.container ? h(i.options.container).append(i.dropdownEl) : i.$el.after(i.dropdownEl), i._makeDropdownFocusable(), i._resetFilterQueryBound = i._resetFilterQuery.bind(i), i._handleDocumentClickBound = i._handleDocumentClick.bind(i), i._handleDocumentTouchmoveBound = i._handleDocumentTouchmove.bind(i), i._handleDropdownClickBound = i._handleDropdownClick.bind(i), i._handleDropdownKeydownBound = i._handleDropdownKeydown.bind(i), i._handleTriggerKeydownBound = i._handleTriggerKeydown.bind(i), i._setupEventHandlers(), i;
        }
        return _inherits(n, Component), _createClass(n, [{ key: "destroy", value: function() {
          ...
          var e2 = t3.toElement || t3.relatedTarget, i = !!h(e2).closest(".dropdown-content").length, n2 = false, s2 = h(e2).closest(".dropdown-trigger");
          s2.length && s2[0].M_Dropdown && s2[0].M_Dropdown.isOpen && (n2 = true), n2 || i || this.close();
        } }, { key: "_handleDocumentClick", value: function(t3) {
          var e2 = this, i = h(t3.target);
          ...
          if (t3.which === M.keys.TAB)
            ...
            if (t3.which === M.keys.ENTER && this.isOpen) {
              var e2 = this.dropdownEl.children[this.focusedIndex], i = h(e2).find("a, button").first();
              i.length ? i[0].click() : e2.click();
            } else
              t3.which === M.keys.ESC && this.isOpen && (t3.preventDefault(), this.close());
          else {
            t3.preventDefault();
            var n2 = t3.which === M.keys.ARROW_DOWN ? 1 : -1, s2 = this.focusedIndex, o = false;
            do {
              if (s2 += n2, this.dropdownEl.children[s2] && this.dropdownEl.children[s2].tabIndex !== -1) {
                o = true;
                break;
              }
            } while (s2 < this.dropdownEl.children.length && 0 <= s2);
            o && (this.focusedIndex = s2, this._focusFocusedItem());
          }
          ...
          var t3 = this.el.getBoundingClientRect(), e2 = this.dropdownEl.getBoundingClientRect(), i = e2.height, n2 = e2.width, s2 = t3.left - e2.left, o = t3.top - e2.top, a = { left: s2, top: o, height: i, width: n2 }, r = this.dropdownEl.offsetParent ? this.dropdownEl.offsetParent : this.dropdownEl.parentNode, l = M.checkPossibleAlignments(this.el, r, a, this.options.coverTrigger ? 0 : t3.height), h2 = "top", d = this.options.alignment;
          if (o += this.options.coverTrigger ? 0 : t3.height, this.isScrollable = false, l.top || (l.bottom ? h2 = "bottom" : (this.isScrollable = true, l.spaceOnTop > l.spaceOnBottom ? (h2 = "bottom", i += l.spaceOnTop, o -= l.spaceOnTop) : i += l.spaceOnBottom)), !l[d]) {
            var u = d === "left" ? "right" : "left";
            l[u] ? d = u : l.spaceOnLeft > l.spaceOnRight ? (d = "right", n2 += l.spaceOnLeft, s2 -= l.spaceOnLeft) : (d = "left", n2 += l.spaceOnRight);
          }
          return h2 === "bottom" && (o = o - e2.height + (this.options.coverTrigger ? t3.height : 0)), d === "right" && (s2 = s2 - e2.width + t3.width), { x: s2, y: o, verticalAlignment: h2, horizontalAlignment: d, height: i, width: n2 };
        } }, { key: "_animateIn", value: function() {
          var i = this;
          s.remove(this.dropdownEl), s({ targets: this.dropdownEl, opacity: { value: [0, 1], easing: "easeOutQuad" }, scaleX: [0.3, 1], scaleY: [0.3, 1], duration: this.options.inDuration, easing: "easeOutQuint", complete: function(t3) {
            if (i.options.autoFocus && i.dropdownEl.focus(), typeof i.options.onOpenEnd == "function") {
              var e2 = t3.animatables[0].target;
              i.options.onOpenEnd.call(e2, i.el);
            }
          } });
        } }, { key: "_animateOut", value: function() {
          var e2 = this;
          s.remove(this.dropdownEl), s({ targets: this.dropdownEl, opacity: { value: 0, easing: "easeOutQuint" }, scaleX: 0.3, scaleY: 0.3, duration: this.options.outDuration, easing: "easeOutQuint", complete: function(t3) {
            if (e2._resetDropdownStyles(), typeof e2.options.onCloseEnd == "function") {
              t3.animatables[0].target;
              e2.options.onCloseEnd.call(e2, e2.el);
            }
          } });
      ...
      var e = { autoClose: false, format: "mmm dd, yyyy", parse: null, defaultDate: null, setDefaultDate: false, disableWeekends: false, disableDayFn: null, firstDay: 0, minDate: null, maxDate: null, yearRange: 10, minYear: 0, maxYear: 9999, minMonth: void 0, maxMonth: void 0, startRange: null, endRange: null, isRTL: false, showMonthAfterYear: false, showDaysInNextAndPreviousMonths: false, container: null, showClearBtn: false, i18n: { cancel: "Cancel", clear: "Clear", done: "Ok", previousMonth: "\u2039", nextMonth: "\u203A", months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], weekdays: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], weekdaysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], weekdaysAbbrev: ["S", "M", "T", "W", "T", "F", "S"] }, events: [], onSelect: null, onOpen: null, onClose: null, onDraw: null }, t = function(t2) {
        ...
        return _inherits(B, Component), _createClass(B, [{ key: "destroy", value: function() {
          ...
          for (var m = false, g2 = 0, _ = 0; g2 < v; g2++) {
            ...
            l.push(this.renderDay($2)), ++_ == 7 && (r.push(this.renderRow(l, n.isRTL, m)), _ = 0, m = !(l = []));
          }
        ...
        return _inherits(n, Component), _createClass(n, [{ key: "destroy", value: function() {
          ...
          if (this.$el.before(t3[0]), !this.el.disabled) {
            ...
            e2.onOpenEnd = function(t4) {
              ...
              if (n2.dropdown.isScrollable && e3.length) {
...
// dep:materialize-css_dist_js_materialize_min
var materialize_css_dist_js_materialize_min_default = require_materialize_min();
export {
  materialize_css_dist_js_materialize_min_default as default
};
/*!
 ...
 */
//# sourceMappingURL=materialize-css_dist_js_materialize_min.js.map
